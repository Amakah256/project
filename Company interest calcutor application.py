...
if __name__ == "__main__":
    ...
    label1 = Label(root, text="Principal Amount(Rs) : ",
                   fg='black', bg='red', font=("Times New Roman", 15))
    ...
    # pads keyword argument used to set padding along x-axis .
    # pad keyword argument used to set padding along y-axis .
    ...
    button1 = Button(root, text="Submit", bg="red",
                     fg="black", command=calculate_ci,font=("Times New Roman", 15))
